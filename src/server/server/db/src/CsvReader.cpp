...
/// \param index 셀 인덱스
////////////////////////////////////////////////////////////////////////////////
void cCsvAlias::AddAlias(const char* name, uint32_t index)
{
...
////////////////////////////////////////////////////////////////////////////////
const char* cCsvAlias::operator [] (uint32_t index) const
{
...
/// \param name 이름
/// \return uint32_t 숫자 인덱스
////////////////////////////////////////////////////////////////////////////////
uint32_t cCsvAlias::operator [] (const char* name) const
{
    ...
    for (uint32_t i=0; i<m_Rows.size(); i++)
    {
        ...
        for (uint32_t j=0; j<row.size(); j++)
        {
            ...
            else
            {
                ...
                for (uint32_t k=0; k<token.size(); k++)
                {
...
/// \return cCsvRow* 해당 행
////////////////////////////////////////////////////////////////////////////////
cCsvRow* cCsvFile::operator [] (uint32_t index)
{
...
////////////////////////////////////////////////////////////////////////////////
const cCsvRow* cCsvFile::operator [] (uint32_t index) const
{
    Assert(index < m_Rows.size());
    return m_Rows[index];
}
...
/// \return uint32_t 현재 행의 셀 숫자
////////////////////////////////////////////////////////////////////////////////
uint32_t cCsvTable::ColCount() const
{
    return CurRow()->size();
}
...
/// \return int32_t 셀 값
////////////////////////////////////////////////////////////////////////////////
int32_t cCsvTable::AsInt(uint32_t index) const
{
...
/// \return double 셀 값
////////////////////////////////////////////////////////////////////////////////
double cCsvTable::AsDouble(uint32_t index) const
{
    const cCsvRow* const row = CurRow();
    Assert(row);
    Assert(index < row->size());
...
////////////////////////////////////////////////////////////////////////////////
const char* cCsvTable::AsStringByIndex(uint32_t index) const
{
    const cCsvRow* const row = CurRow();
    Assert(row);
    Assert(index < row->size());

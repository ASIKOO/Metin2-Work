...
//
//bool AuctionManager::InsertAuctionMoney (uint32_t player_id, int32_t money)
//{
...
//}
//
//bool AuctionManager::ChangeAuctionMoney (uint32_t player_id, int32_t changing_amount)
//{
//	TAuctionMoneyMap::iterator it = auction_item_map.find (player_id);
//	if (it == auction_item_map.end())
//		return false;

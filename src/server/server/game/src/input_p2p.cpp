...
int32_t CInputP2P::Relay(LPDESC d, const char * c_pData, uint32_t uiBytes)
{
...
int32_t CInputP2P::MonarchNotice(LPDESC d, const char * c_pData, uint32_t uiBytes)
{
...
int32_t CInputP2P::Guild(LPDESC d, const char* c_pData, uint32_t uiBytes)
{

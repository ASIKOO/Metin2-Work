...
private:
	...
	typedef std::unordered_map<uint32_t, PoolType> PoolMapType;
	typedef std::unordered_map<void*, uint32_t> AllocMapType;

	static const uint32_t kWatermark = 4; // FIFO enforcement level

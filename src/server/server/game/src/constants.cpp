 ...
 */
{
	// str con dex int32_t 초기HP 초기SP  CON/HP int32_t/SP  HP랜덤/lv   MP랜덤/lv  초기stam  stam/con stam/lv
...
const uint32_t * exp_table = NULL;

const uint32_t exp_table_euckr[PLAYER_EXP_TABLE_MAX + 1] =	
{
	0,			// 0
...
const uint32_t exp_table_newcibn[PLAYER_EXP_TABLE_MAX + 1 ] =
{
	300,	// 0
	800,	// 1
	1500,
...
const int32_t * aiPercentByDeltaLev = NULL;
const int32_t * aiPercentByDeltaLevForBoss = NULL;
...
const int32_t * aiChainLightningCountBySkillLevel = NULL;

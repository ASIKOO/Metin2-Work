...
void CGuildManager::GetHighRankString(uint32_t dwMyGuild, char * buffer, uint32_t buflen)
{
	using namespace std;
	vector<CGuild*> v;
...
void CGuildManager::GetAroundRankString(uint32_t dwMyGuild, char * buffer, uint32_t buflen)
{
	using namespace std;
	vector<CGuild*> v;
